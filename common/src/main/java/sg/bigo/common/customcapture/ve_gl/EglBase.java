...
package sg.bigo.common.customcapture.ve_gl;
...
public abstract class EglBase {
    ...
    public static final int[] CONFIG_RECORDABLE = {
            ...
            EGL10.EGL_BLUE_SIZE, 8,
            EGL10.EGL_RENDERABLE_TYPE, EGL_OPENGL_ES2_BIT,
            EGL_RECORDABLE_ANDROID, 1, //表示该EGL使用的Surface将用做实时采集 Indicates that the Surface used by this EGL will be used for real-time acquisition
            EGL10.EGL_NONE
    };
    // clang-format on
