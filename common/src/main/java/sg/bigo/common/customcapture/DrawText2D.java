...
class DrawText2D {
    ...
    public DrawText2D(final String vertexShader, final String fragmentShader) {
    ...
    public void onDrawText2D(final int textureId, int displayWidth, int displayHeight) {
