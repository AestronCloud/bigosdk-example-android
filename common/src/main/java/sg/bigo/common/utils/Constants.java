...
public class Constants {
    ...
    public static final int DEFAULT_FPS_IDX = 3;
    public static final String PREF_RESOLUTION_IDX = "pref_profile_index";
    public static final String PREF_FPS_IDX = "pref_fps_idx";
    public static final String PREF_ENABLE_STATS = "pref_enable_stats";
    public static final String PREF_ENABLE_CUSTOM_CAPTURE = "pref_custom_capture";
    ...
    public static final String PREF_BITRATE = "pref_bitrate";
    public static final String PREF_AUDIO_PROFILE = "pref_audio_profile";
    public static final String PREF_AUDIO_SCENARIO = "pref_audio_scenario";
